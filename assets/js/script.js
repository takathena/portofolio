...
const certificatesDB = [
  ...
  },
  {
    ...
    issuer: "CODING REBELLION",
    issuerIcon: "https://cdn-icons-png.flaticon.com/512/5968/5968764.png",
    date: "JANUARY 2024",
    category: "programming",
    image: "https://images.unsplash.com/photo-1515879218367-8466d910aaa4?w=800&h=400&fit=crop",
    badge: "ADVANCED",
    description: "Pushing the boundaries of conventional programming with unorthodox approaches and experimental techniques.",
    shortDescription: "Pushing programming boundaries with unorthodox approaches.",
    skills: ["EXPERIMENTAL CODE", "ALGORITHMS", "CREATIVE CODING", "PROTOTYPING"],
    validation: "CERT ID: CR-EXPCODE-2024-002",
    viewLink: "https://example.com/cert/experimental-coding",
    credentialLink: "https://verify.codingrebellion.com/expcode-002"
  },
  {
    id: 2,
    ...
    badge: "PROFESSIONAL",
    description: "Comprehensive AI and machine learning certification covering neural networks, deep learning, and practical applications.",
    shortDescription: "Comprehensive AI and machine learning certification from Google.",
    skills: ["PYTHON", "TENSORFLOW", "NEURAL NETWORKS", "DEEP LEARNING", "NLP"],
    validation: "CERT ID: GOOGLE-AI-2023-789",
    viewLink: "https://example.com/cert/google-ai",
    credentialLink: "https://verify.google.com/ai-789"
  },
  {
    id: 3,
    ...
    shortDescription: "Full stack web development certification from Meta.",
    skills: ["REACT", "NODE.JS", "EXPRESS", "MONGODB", "DOCKER"],
    validation: "CERT ID: META-WEB-2023-456",
    viewLink: "https://example.com/cert/meta-web",
    credentialLink: "https://verify.meta.com/web-456"
  },
  {
    id: 4,
    ...
    date: "OCTOBER 2023",
    category: "cloud",
    image: "https://images.unsplash.com/photo-1542744095-fcf48d80b0fd?w=800&h=400&fit=crop",
    badge: "ASSOCIATE",
    description: "AWS cloud practitioner certification covering cloud fundamentals, services, and architecture.",
    shortDescription: "AWS cloud practitioner certification.",
    skills: ["AWS", "CLOUD ARCHITECTURE", "DEVOPS", "SECURITY", "SCALING"],
    validation: "CERT ID: AWS-CLOUD-2023-123",
    viewLink: "https://example.com/cert/aws-cloud",
    credentialLink: "https://verify.aws.com/cloud-123"
  },
  {
    id: 5,
    title: "DATA SCIENCE",
    ...
    image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&h=400&fit=crop",
    badge: "PROFESSIONAL",
    description: "Data science specialization covering statistics, machine learning, and data visualization.",
    shortDescription: "Data science specialization from IBM.",
    skills: ["PYTHON", "PANDAS", "NUMPY", "STATISTICS", "DATA VIZ"],
    validation: "CERT ID: IBM-DATA-2023-987",
    viewLink: "https://example.com/cert/ibm-data",
    credentialLink: "https://verify.ibm.com/data-987"
  },
  {
    id: 6,
    title: "CYBERSECURITY",
    ...
    badge: "FUNDAMENTALS",
    description: "Cybersecurity fundamentals covering network security, cryptography, and threat analysis.",
    shortDescription: "Cybersecurity fundamentals from Cisco.",
    skills: ["NETWORK SECURITY", "CRYPTOGRAPHY", "THREAT ANALYSIS", "ETHICAL HACKING"],
    validation: "CERT ID: CISCO-CYBER-2023-654",
    viewLink: "https://example.com/cert/cisco-cyber",
    credentialLink: "https://verify.cisco.com/cyber-654"
  },
  {
    id: 7,
    ...
    badge: "ASSOCIATE",
    description: "Database management certification covering SQL, normalization, and performance optimization.",
    shortDescription: "Database management certification from Oracle.",
    skills: ["SQL", "DATABASE DESIGN", "NORMALIZATION", "PERFORMANCE", "BACKUP"],
    validation: "CERT ID: ORACLE-DB-2023-321",
    viewLink: "https://example.com/cert/oracle-db",
    credentialLink: "https://verify.oracle.com/db-321"
  }
];
